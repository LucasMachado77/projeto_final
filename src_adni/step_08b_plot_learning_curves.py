...
def parse_args() -> argparse.Namespace:
    # Permite apontar qualquer history.csv; no 08b o default aponta para o ViT.
    ...
    parser.add_argument(
        '--history-csv',
        type=Path,
        default=Path('reports_adni/vit_transfer_learning_grouped_binary/history.csv'),
